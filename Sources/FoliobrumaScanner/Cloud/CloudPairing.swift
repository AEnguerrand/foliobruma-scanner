...
struct CloudPairing {
  ...
  func browserURL(ticket: Ticket, now: Date = Date()) throws -> URL {
    ...
    var url = URLComponents(url: CloudAPI.origin.appendingPathComponent("app/"), resolvingAgainstBaseURL: false)!
